...
public class AuthorizationConfigurationTests
{
    ...
    [InlineData(typeof(DocumentDetailsModel), "OnPostDeleteAsync")]
    ...
    [Fact]
    public void OperationalViews_ShouldUseToastFeedbackInsteadOfBrowserDialogs()
    {
        ...
        documentDetailsView.Should().Contain("data-toast-confirm=\"true\"");
